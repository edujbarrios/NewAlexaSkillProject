...
const ANIMALS_FACT_LOOKUP = "ANIMALS_FACTS"
const FILMS_FACT_LOOKUP = "FILMS_FACTS"
const FOOD_FACTS_LOOKUP = "FOOD_FACTS"
...
/**
 * Use topic name map corresponding fact topic else default to ANIMALS_FACTS.
 * 
...
const getTopicLookupText = (topicName, requestAttributes) => {
  if (topicName) {
    switch (topicName.toString().toLowerCase()) {
      case requestAttributes.t(FILMS).toLowerCase():
        return FILMS_FACT_LOOKUP;
      case requestAttributes.t(FOOD).toLowerCase():
        return FOOD_FACTS_LOOKUP;
      default:
        return ANIMALS_FACT_LOOKUP;
    }
  }
  return ANIMALS_FACT_LOOKUP;
}
